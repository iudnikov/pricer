...
public class AppConfig {
    ...
    */
    ...
    public PricerService pricerServiceNew(
        ...
        return new PricerService(objectMapper, cacheRepoRedis, UUID::randomUUID, maxWinsPercentage, minCostsPercentage, guidelineWriter, priceIncreaseStep, moneyExchanger, directivePublisherSNS, cacheRepoRedis, guidelineReader);
    }
